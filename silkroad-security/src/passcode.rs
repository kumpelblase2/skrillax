...
impl PassCodeDecoder {
    pub fn decode_passcode(
        ...
        self.blowfish
            .decrypt_block(GenericArray::from_mut_slice(&mut data));
...
impl Default for PassCodeDecoder {
    fn default() -> Self {
        ...
        let blowfish =
            BlowfishCompat::new_from_slice(&blowfish_key).expect("Could not create blowfish key");
